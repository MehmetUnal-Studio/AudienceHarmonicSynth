...
| 2 | [UI Guide](02-ui-guide.md) | Header version/metrics, OSC input, Source Matrix, Time Field, Tonal/Atomic pitch mapping, Normal/MPE routing, destinations, simulator, and Panic. |
